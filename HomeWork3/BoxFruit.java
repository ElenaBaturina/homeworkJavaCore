...
public class BoxFruit<F> {
    ...
    public void addFruits(BoxFruit<F> boxFruit){
        System.out.println("Перед пересыпанием. Ящик 1: " + fruits.size());
        System.out.println("Перед пересыпанием. Ящик 2: " + boxFruit.fruits.size());
        fruits.addAll(boxFruit.fruits);
        boxFruit.fruits.clear();
        System.out.println("После пересыпания. Ящик 1: " + fruits.size());
        System.out.println("После пересыпания. Ящик 2: " + boxFruit.fruits.size());
    }
